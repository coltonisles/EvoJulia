...
## =====================
# Functionalizing
def generate_julia(c_real, c_imag, x_offset, y_offset, zoom, width=samples.sample_resolution, height=samples.sample_resolution, max_iter=120):
    WIDTH = width        
    LENGTH = height
    MAX_ITERATIONS = max_iter
    
    c = complex(c_real, c_imag)
    x_min = (fractal.x_min / zoom + x_offset)
    y_min = (fractal.y_min / zoom + y_offset)
    x_max = (fractal.x_max / zoom + x_offset)
    y_max = (fractal.y_max / zoom + y_offset)
